...
function updatefishconfig; echo (curl -L "https://raw.githubusercontent.com/koumaza/dot/default/linux/fish/config.fish" | tee ~/.config/fish/config.fish) 1>/dev/null; end
alias l="ls"
alias b="bash -c"
alias v="vim"
alias n="nvim"
